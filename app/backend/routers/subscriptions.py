...
class SubscriptionsData(BaseModel):
    ...
    plan_type: str
    single_credits: int = None
    monthly_posts_today: int = None
    monthly_expires_at: str = None
...
class SubscriptionsUpdateData(BaseModel):
    ...
    single_credits: Optional[int] = None
    monthly_posts_today: Optional[int] = None
    monthly_expires_at: Optional[str] = None
